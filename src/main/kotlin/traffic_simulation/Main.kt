...
fun testScenarioWithInternList() {
    ...
    val truck1: Vehicle = Vehicle(id = 13, wannaDriveInHours = mutableListOf(1, 2, 3, 4, 11, 12, 13, 14, 15, 19, 20, 21, 22, 23, 24))
    val truck2: Vehicle = Vehicle(id = 14, wannaDriveInHours = mutableListOf(1, 2, 3, 4, 11, 12, 13, 14, 15, 19, 20, 21, 22, 23, 24))
    val truck3: Vehicle = Vehicle(id = 15, wannaDriveInHours = mutableListOf(1, 2, 3, 4, 11, 12, 13, 14, 15, 19, 20, 21, 22, 23, 24))
    val truck4: Vehicle = Vehicle(id = 16, wannaDriveInHours = mutableListOf(1, 2, 3, 4, 11, 12, 13, 14, 15, 19, 20, 21, 22, 23, 24))
    val tram1: Vehicle = Vehicle(id = 17, wannaDriveInHours = mutableListOf(1, 2, 3, 4, 11, 12, 13, 14, 15, 19, 20, 21, 22, 23, 24))
    val tram2: Vehicle = Vehicle(id = 18, wannaDriveInHours = mutableListOf(1, 2, 3, 4, 11, 12, 13, 14, 15, 19, 20, 21, 22, 23, 24))
    val tram3: Vehicle = Vehicle(id = 19, wannaDriveInHours = mutableListOf(1, 2, 3, 4, 11, 12, 13, 14, 15, 19, 20, 21, 22, 23, 24))
    val tram4: Vehicle = Vehicle(id = 20, wannaDriveInHours = mutableListOf(1, 2, 3, 4, 11, 12, 13, 14, 15, 19, 20, 21, 22, 23, 24))
    val bike1: Vehicle = Vehicle(id = 21, wannaDriveInHours = mutableListOf(1, 2, 3, 4, 11, 12, 13, 14, 15, 19, 20, 21, 22, 23, 24))
    val bike2: Vehicle = Vehicle(id = 22, wannaDriveInHours = mutableListOf(1, 2, 3, 4, 11, 12, 13, 14, 15, 19, 20, 21, 22, 23, 24))
    val bike3: Vehicle = Vehicle(id = 23, wannaDriveInHours = mutableListOf(1, 2, 3, 4, 11, 12, 13, 14, 15, 19, 20, 21, 22, 23, 24))
    val bike4: Vehicle = Vehicle(id = 24, wannaDriveInHours = mutableListOf(1, 2, 3, 4, 11, 12, 13, 14, 15, 19, 20, 21, 22, 23, 24))
